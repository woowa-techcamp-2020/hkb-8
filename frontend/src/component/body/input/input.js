...
export class Input {
    ...
    toggle() {
        ...
        inputSection.querySelector('.classification-income').classList.toggle('clicked');
        inputSection.querySelector('.classification-outcome').classList.toggle('clicked');
        inputSection.querySelector('.income-select').classList.toggle('hidden');
        inputSection.querySelector('.outcome-select').classList.toggle('hidden');
    }
